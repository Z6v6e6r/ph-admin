(function (global) {
  ...
  function ensureStyles() {
    ...
    style.textContent =
      ...
      '.phab-ref-card{min-width:0;max-width:100%;background:#fff;border:1px solid rgba(51,0,32,.12);border-radius:17px;box-shadow:0 8px 24px rgba(51,0,32,.05)}' +
      ...
      '.phab-ref-detail{min-width:0;padding:18px}.phab-ref-detail-head{display:flex;justify-content:space-between;gap:12px;align-items:flex-start}.phab-ref-detail-head>div:first-child{min-width:0}.phab-ref-detail h3{margin:0;font-size:18px}.phab-ref-meta{overflow-wrap:anywhere}.phab-ref-public{display:flex;min-width:0;gap:7px;margin:13px 0}.phab-ref-public input{min-width:0;flex:1;padding:9px 10px;border:1px solid rgba(51,0,32,.14);border-radius:9px;color:#655861;background:#faf9fa}' +
      ...
      '@media(max-width:640px){.phab-ref-page{padding:16px 9px 90px}.phab-ref-head,.phab-ref-detail-head,.phab-ref-public{flex-direction:column}.phab-ref-detail{padding:14px}.phab-ref-detail-head .phab-ref-actions,.phab-ref-public input,.phab-ref-public .phab-ref-btn{width:100%}.phab-ref-kpis{grid-template-columns:repeat(2,minmax(0,1fr))}.phab-ref-form{grid-template-columns:1fr}.phab-ref-wide{grid-column:auto}.phab-ref-filter{align-items:stretch}.phab-ref-field{min-width:calc(50% - 6px)}.phab-ref-field.grow{min-width:100%}}';
