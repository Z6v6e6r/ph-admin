  ...
  function panelInstance(rawConfig) {
    ...
    function normalizeLegacyDialog(item) {
      ...
      return {
        ...
        resolvedAt: item.isResolved === true ? item.resolvedAt || undefined : undefined,
        resolvedByUserId: item.isResolved === true ? item.resolvedByUserId || undefined : undefined,
